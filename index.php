	  ...
	  <span></span><img src="images/about-img.png" alt=""><span></span>
	   ...
	   <div class="container">
		 <div class="col-md-4 about-grids">
			 <h4><span class="icon1"></span>Vì sao nên chọn chúng tôi ?</h4>
			 <p>Travel.com cũng sẽ mang đến cho du khách những dịch vụ chất lượng hàng đầu với mức giá ổn nhất</p>
		 </div>
		 <div class="col-md-4 about-grids grid2">
			 <h4><span class="icon2"></span>Chỉ tiêu dịch vụ</h4>
			 <p>Đa dạng - Chất lượng - khuyến mãi hấp dẫn</p>
		 </div>
		 <div class="col-md-4 about-grids">
			 <h4><span class="icon3"></span>Định hướng</h4>
			 <p>Luôn làm mới các tuyến tour truyền thống ,cập nhập các điểm đến đang hot</p>
...
<div class="tour-guides section" id="section-4" >
	  <div class="tour-guides-head text-center">
		  ...
		  <div class="container">
				<p>Tour Hot Khuyến Mãi là các chương trình tour ưu đãi giảm giá của chúng tôi nhằm đáp ứng nhu cầu đi du lịch của mọi người. Các tour du lịch giá rẻ siêu tiết kiệm bao gồm cả các tour du lịch trong nước và du lịch nước ngoài được khởi hành hàng tuần. Các chương trình này áp dụng giảm giá đặc biệt, chất lượng không đổi và số lượng chỗ có hạn..</p>
		  </div>
	  </div>
	  <div class="container">
...
<?php }?>
	...
	<div class="col-md-3 image-grid">
					 <img src="Admin/addverimages/tfd_220105044735_228319.jpg" width="300px" height="150px" >

					 <p><a href="https://code-projects.org/">Trekking Cần Giờ - Khám phá rừng phòng hộ - Thưởng thức hải sản tươi ngon và Chèo Sup xuyên rừng ngập mặn</a></p>
				 </div>
	<div class="col-md-3 image-grid">
					 <img src="Admin/addverimages/tfd_211112025606_018157.jpg" width="300px" height="150px" >

					 <p><a href="http://localhost/travel%20MGMT%20PHP/Travel/detail.php?pid=25">Bay cùng Vietravel Airlines | Phú Quốc - Vinpearl Oasis Resort - Thỏa Thích Vui Chơi Tại Vinwonders & Safari</a></p>
				 </div>
	<div class="col-md-3 image-grid">
					 <img src="Admin/addverimages/tf_220207045018_712738-002.jpg" width="300px" height="150px" >

					 <p><a href="http://localhost/travel%20MGMT%20PHP/Travel/detail.php?pid=50">Bay cùng Vietravel Airlines | Đà Nẵng - Huế - Đầm Lập An - La Vang - Động Phong Nha & Thiên Đường - KDL Bà Nà - Cầu Vàng -Sơn Trà - Hội An - Đà Nẵng (Khách sạn 4* trọn tour)</a></p>
				 </div>
	 <div class="col-md-3 image-grid">
					 <img src="Admin/addverimages/tfd_220221031155_148019.jpg" width="300px" height="150px" >

					 <p><a href="http://localhost/travel%20MGMT%20PHP/Travel/detail.php?pid=2">Đồng Nai - Chinh phục Núi Chứa Chan - KDL Thảo Thiện Garden</a></p>
					 </div>
				<?php if($n%4==0)
				{?>
            </div>
...
<div id="section-5" class="contact section">
	  <div class="contact-head text-center">
          ...
          <h4 style="color:#000">Lên kế hoạch cho chuyến đi của bạn chúng tôi có thể giúp bạn đặt vé ngay bây giờ!</h4>

		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						<h4 style="color:#09F">N-L-P-M-Q-T-C </h4>
						<p style="color:#000">Cần trợ giúp khi đặt gói<br/>
                        Để có những gợi ý tuyệt vời, bạn cũng có thể gọi cho chúng tôi</p>
						<h5 style="color:#000"><span class="img1"></span>(+91) 9876543210&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;9874561230</h5>
						<h5 style="color:#000"><span class="img2"></span><a href="#">www.travel.com.vn&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;</a></h5>
						<h5 style="color:#000"><span class="img3"></span>459 Tôn Đức Thắng,phường Hòa Khánh Nam,Quận Liên Chiểu</h5>
                        <br/>
