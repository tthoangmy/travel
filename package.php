...
<?php
$s="select * from package where package.subcategory='" . $_GET["subcatid"] ."'";// hien thi het thong tin trong bang subcateory
$result=mysqli_query($cn,$s);
$r=mysqli_num_rows($result);
//echo $r;
$n=0;
...
<tr><td align="center" style="background-color:#60B0E6; font-size:20px; font-family:Lucida Calligraphy; color:#FFF
;display: block;
  	display: -webkit-box;
  	height: 16px*1.3*3;
  	line-height: 1.3;
  	...
  	margin-top:10px"><?php echo $data[1]; ?></td></tr>
